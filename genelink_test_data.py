...
parser.add_argument('--data_type',type=str,default='mESC', help='choose dataset hESC, Dataset mESC or Dataset PBMC')
...
base_dir = '/home/zh/pycharm_file/GeneLink_Plus/example/dataset/hTFTarget/B/TFs+9000'
train_test_val_dir = '/home/zh/pycharm_file/GeneLink_Plus/example/Train_validation_test/hTFTarget/B/TFs+9000'
# density = Network_Statistic(data_type,num,net_type)
exp_file = base_dir+'/BL--ExpressionData.csv'
tf_file = base_dir+'/TF.csv'
target_file = base_dir+'/Target.csv'
...
train_file = train_test_val_dir+'/Train_set.csv'
test_file = train_test_val_dir+'/Test_set.csv'
val_file = train_test_val_dir+'/Validation_set.csv'
